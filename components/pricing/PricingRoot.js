        ...
        <div className='flex flex-col lg:flex-row items-center lg:items-stretch justify-center gap-6 mb-8'>
          <OfferCard
            ...
            btnText={
              !user.info
                ? 'Create free account'
                : (user.info.membership === 'basic'
                  ? 'active'
                  : 'downgrade')
            }
            btnDisabled={user.info && user.info.membership === 'basic'}
          >
          ...
          <OfferCard
            ...
            popular
            btnTheme='nice'
            btnText={(!user.info || user.info.membership === 'basic')
              ? 'upgrade now'
              : user.info.membership == 'pro'
                ? 'active'
                : 'change plan'
            }
            btnDisabled={user.info && user.info.membership === 'pro'}
          >
          ...
          <OfferCard
            ...
            price={9.99}
            btnTheme='nice'
            btnText={(!user.info || user.info.membership !== 'elite')
              ? 'upgrade now'
              : 'active'
            }
            btnDisabled={user.info && user.info.membership === 'elite'}
          >
