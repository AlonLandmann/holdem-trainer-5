          ...
          <div className='flex flex-col gap-10'>
            ...
            <SupportFaqItem
              ...
              answer={`
                ...
                You can learn more about the HT-Pro and HT-Elite tiers at /pricing (XXX).
              `}
            />
            ...
            <SupportFaqItem
              question="Setting up ranges seems difficult and time consuming, is there a faster way?"
              answer={`
                Before anyting else, make sure you are using the essential hotkeys that are available for building ranges more quickly.
                You can learn what they are by clicking on the alt-icon in the editor toolbar. (XXX).
            ...
            <SupportFaqItem
              question='If we cannot play with a random number generator in live games, why train with one?'
              answer={`
            ...
            <SupportFaqItem
              question='How are the points earned after a training session calculated?'
              answer={`
